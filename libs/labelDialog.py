...
class LabelDialog(QDialog):
    ...
    def __init__(self, text="Enter object label", parent=None, list_item=None):
        ...
        if list_item is not None and len(list_item) > 0:
            ...
            self.list_widget.customContextMenuRequested.connect(self._list_right_click)
    ...
    def eventFilter(self, obj, event):
        if obj is self.edit and event.type() == QEvent.MouseButtonRelease:
    ...
    def _list_right_click(self, pos):
